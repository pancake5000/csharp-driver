...
namespace Cassandra.IntegrationTests.Policies.Tests
{
    ...
    public class LoadBalancingPolicyShortTests : SharedClusterTest
    {
        ...
        // [Test]
        // public void RoundRobin_SimpleStatement_Hits_All_Nodes()
        // {
        ...
        //         var coordinators = new Dictionary<IPEndPoint, int>();

        //         for (var i = 0; i < 60; i++)
        //         {
        //             var rs = session.Execute("SELECT keyspace_name FROM system_schema.keyspaces LIMIT 1");
        //             var host = rs.Info.QueriedHost;
        //             coordinators[host] = coordinators.TryGetValue(host, out var c) ? c + 1 : 1;
        //         }

        //         // Expect all 3 nodes in the SharedClusterTest (3-node) to be used
        //         Assert.AreEqual(3, coordinators.Count, "Expected queries to hit all 3 nodes");
        //         foreach (var kv in coordinators)
        //         {
        //             Assert.Greater(kv.Value, 5, $"Host {kv.Key} was barely used");
        //         }
        //     }
        //     finally
        //     {
        ...
        // [Test]
        // public void TokenAware_WithoutRoutingKey_ActsLike_RoundRobin()
        // {
        //     var cluster = ClusterBuilder()
        //         .AddContactPoint(TestCluster.InitialContactPoint)
        ...
        //         for (var i = 0; i < 60; i++)
        //         {
        //             // No routing key, plain simple statement
        //             var rs = session.Execute("SELECT keyspace_name FROM system_schema.keyspaces LIMIT 1");
        //             var host = rs.Info.QueriedHost;
        //             coordinators[host] = coordinators.TryGetValue(host, out var c) ? c + 1 : 1;
        //         }

        //         Assert.AreEqual(3, coordinators.Count, "Expected TokenAware(RoundRobin) to hit all 3 nodes");
        //     }
        //     finally
        //     {
        //         cluster.Dispose();
